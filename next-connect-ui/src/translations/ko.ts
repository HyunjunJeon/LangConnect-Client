export const ko = {
  ...
  mcp: {
    ...
    server: {
      ...
      viewDetails: '상세 정보',
      viewLogs: '로그 보기',
      copyConfig: 'MCP 설정 복사',
      configCopied: '설정 복사됨',
      configCopiedDescription: 'MCP 설정이 클립보드에 복사되었습니다',
      configCopyError: '복사 실패',
      configCopyErrorDescription: '설정을 클립보드에 복사할 수 없습니다',
      elicitation: '대화형 도구',
      ...
      createAndStartSuccess: '서버 생성 및 시작됨',
      createAndStartSuccessDescription: '{{name}} 서버가 성공적으로 생성되고 시작되었습니다.',
      autoStartError: '자동 시작 실패',
      autoStartErrorDescription: '서버가 생성되었지만 자동으로 시작할 수 없었습니다. 수동으로 시작해주세요.',
